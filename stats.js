...
let wordWebsDate = new LabelCard(wordWebsCard, "Feb 2nd");

let analogsCard = document.getElementById('analogs');
let analogsDate = new LabelCard(analogsCard, "Jan 31st");

let scrambleCard = document.getElementById('scramble');
let scrambleDate = new LabelCard(scrambleCard, "Feb 2nd");
